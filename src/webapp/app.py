...
# ``AppContext`` service container now live in session_state.py (F-6 split) and
# are imported at the top of this module. AUTOSAVE_DIR is imported too. - Claude Generated
