...
# Workflow-discovery endpoints (/api/workflows) extracted to routers/workflows.py
# (F-6 split). _discover_workflows re-exported below for the unit test that
# imports it via src.webapp.app. - Claude Generated
