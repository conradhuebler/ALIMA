...
SHARED_RULES = (
    ...
    "Katalog-Links (ZWINGEND — gilt in ALLEN Modi):\n"
    "- Wenn ein Tool-Ergebnis ein `web_url`-Feld enthält, MUSS der Titel\n"
    "  als Markdown-Link ausgegeben werden: [Titel](web_url)\n"
    "  Beispiel: [Anorganische Chemie](https://katalog.ub.tu-freiberg.de/Record/0-123)\n"
    "- JEDEN Treffer mit `web_url` verlinken — keinen auslassen.\n"
...
MODE_SUCHE = (
    ...
    "  DK-Codes, GND-ID.\n"
    "- Katalog-Links: Siehe SHARED_RULES (gilt hier zwingend).\n"
    "  Fallback ohne `web_url`: numerische `rsn` vorhanden → <<CAT:RSN|Titel>>;\n"
    "  weder noch → nur Titeltext.\n\n"
    "Was du NICHT tun sollst:\n"
